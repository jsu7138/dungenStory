...
public class Stage_8_Activity extends SimpleBaseGameActivity {
    ...
    protected Scene onCreateScene() {
        ...
        try {
            ...
            // 타일맵 로드
            this.mTMXTiledMap = tmxLoader.loadFromAsset("tmx/stage8.tmx");
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),1,1570,2,5,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),1,1870,7,5,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),1,355,15,6,1,0);
        battleEnermy1.add(asd);
