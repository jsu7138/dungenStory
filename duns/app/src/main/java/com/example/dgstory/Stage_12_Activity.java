...
public class Stage_12_Activity extends SimpleBaseGameActivity {
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),4,570,13,25,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),1,1270,2,5,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),1,1170,11,5,1,0);
        battleEnermy1.add(asd);
