...
public class Stage_7_Activity extends SimpleBaseGameActivity {
    ...
    public static float mImpulseY = 15.5f;           //플레이어 점프력
    ...
    protected Scene onCreateScene() {
        ...
        try {
            ...
            // 타일맵 로드
            this.mTMXTiledMap = tmxLoader.loadFromAsset("tmx/stage7.tmx");
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),1,1170,21,5,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),1,1470,15,5,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),1,1422,15,6,1,0);
        battleEnermy1.add(asd);
