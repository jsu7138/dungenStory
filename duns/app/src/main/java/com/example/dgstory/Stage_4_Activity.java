...
public class Stage_4_Activity extends SimpleBaseGameActivity {
    ...
    public static float mImpulseY = 6.5f;           //플레이어 점프력
    ...
    protected Scene onCreateScene() {
        ...
        try {
            ...
            // 타일맵 로드
            this.mTMXTiledMap = tmxLoader.loadFromAsset("tmx/stage4.tmx");
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),1,70,2,5,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),1,470,7,5,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),1,422,15,6,1,0);
        battleEnermy1.add(asd);
