...
public class Stage_13_Activity extends SimpleBaseGameActivity {
    ...
    protected Scene onCreateScene() {
        ...
        try {
            ...
            // 타일맵 로드
            this.mTMXTiledMap = tmxLoader.loadFromAsset("tmx/stage3.tmx");
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),4,570,21,5,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),6,970,17,1,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),8,1422,15,6,1,0);
        battleEnermy1.add(asd);
