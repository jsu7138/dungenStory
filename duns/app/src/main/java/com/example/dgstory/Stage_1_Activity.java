...
public class Stage_1_Activity extends SimpleBaseGameActivity {
                    ...
                    if(fix1_name.contains("arrow")){
                        ...
                        if (targetNumber >= 0) {
                            int damage = damageCalculation.getDamageCalculation(false,
                                    ...
                                    battleEnermy1.get(targetNumber).def,
                                    battleEnermy1.get(targetNumber).p_def);
                            float tmp_xDistance = 3f;
                            float levelbalance = battleEnermy1.get(targetNumber).lv - player_info.myLevel;
                            if(levelbalance >=5){
                                tmp_xDistance = 3f - ( (levelbalance-7) *  0.4f);
                            }
    ...
    public void showBaseEnemySkill(final int _enermyNumber, Sprite _enermySprite, int _enermyDir, final int _number){
        ...
        int temp_x = 360, temp_y = 55;
        if(_enermyDir == 1){
            temp_y += 20; temp_x -= 120;
        }
    ...
    public void dataPlayer(){
        ...
        //공속 셋팅
        sword_speed = 101 - (int)((player_info.myA_Speed)/200f * 100f);
        sword_delay = 0.808f - (((player_info.myA_Speed)/200f * 100f) * 0.008f);
        if(player_info.myCharacterNum == 1){
    ...
    public void showEnemy(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("enemy"+ String.valueOf(enemyCount),1,300
                ,2,5,1,0);
    ...
    public void showEnemy2(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("middle"+ String.valueOf(enemyCount2),1,130,5,2,1,0);
        battleEnermy1.add(asd);
    ...
    public void showEnemy3(int xLoc, int yLoc) {
        ...
        battle_enermy asd = new battle_enermy("high"+ String.valueOf(enemyCount3),1,160,7,1,1,0);
        battleEnermy1.add(asd);
